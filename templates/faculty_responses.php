 ...
 * @package  Acad Plugin
 */
use Inc\Api\Callbacks\FacultyResponsesCallbacks;
?>
	...
	<div class="tab-content">
		<div id="tab-1" class="tab-pane active">
			...
			<form method="post" action="<?php echo admin_url( 'admin-post.php'); ?>">
				<?php
					settings_fields( 'acad_faculty_responsess_options_group' );
					do_settings_sections( 'acad_faculty_responses' );
					submit_button();
				?>
			</form>
		...
		<div id="tab-2" class="tab-pane">
			...
			<?php
				...
				$faculty_responses->viewFacultyResponsess();
			?>
		 </div>
