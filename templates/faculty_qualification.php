	...
	<div class="tab-content">
		<div id="tab-1" class="tab-pane active">
			...
			<form method="post" action="<?php echo admin_url( 'admin-post.php'); ?>">
				<?php
					settings_fields( 'acad_faculty_qualifications_options_group' );
					do_settings_sections( 'acad_faculty_qualification' );
					submit_button();
				?>
			</form>
		...
		<div id="tab-2" class="tab-pane">
			...
			<?php
				...
				$faculty_qualification->viewFacultyQualifications();
			?>
		 </div>
