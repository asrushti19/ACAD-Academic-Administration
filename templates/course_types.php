...
<div class="wrap">
  ...
  <div class="tab-content">
        ...
        <?php
					settings_fields( 'acad_course_types_options_group' );
					do_settings_sections( 'acad_course_types' );
					submit_button();
				?>
			</form>
		...
		<div id="tab-2" class="tab-pane">
			<h3> View </h3>
      <?php
        $types = new CourseTypesCallbacks();
        $types->viewCourseTypes();
      ?>
		 </div>
