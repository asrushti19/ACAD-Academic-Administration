...
class FacultyExperienceCallbacks extends BaseController {
  ...
  public function displayFromDate() {
    ...
    echo '<input type="text" class="regular-text" name="from_date" value="' . $value . '" placeholder="From">';
  }

  public function displayToDate() {
    $value = esc_attr( get_option('to_date') );
    echo '<input type="text" class="regular-text" name="to_date" value="' . $value . '" placeholder="To">';
  }
