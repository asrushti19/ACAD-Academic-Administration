...
class DepartmentCallbacks extends BaseController {
  ...
  public function displayEstablishmentYear() {
    ...
    echo '<input type="text" class="regular-text" name="establishment_year" value="' . $value . '" placeholder="Establishment Year">';
  }
  ...
  public function displayPhoneNo() {
    ...
    echo '<input type="text" class="regular-text" name="phone_no" value="' . $value . '" placeholder="Phone Number">';
  }

  public function displayEmail() {
    $value = esc_attr( get_option('email') );
    echo '<input type="text" class="regular-text" name="email" value="' . $value . '" placeholder="Email">';
  }
  ...
  public function updateDepartment() {
    if( current_user_can('update_department') ) {
